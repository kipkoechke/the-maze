...
/**
 * Finds horizontal intersection with a wall.
 * 
 * @param rayAngle: The current ray angle.
 */
...
/**
 * Finds vertical intersection with a wall.
 * 
 * @param rayAngle: The current ray angle.
 */
 ...
 * @param stripId: Identifier for the ray strip.
 */
...
/**
 * Casts all rays from player's vision.
 */
...
/**
 * Renders the rays for visualization.
 */
